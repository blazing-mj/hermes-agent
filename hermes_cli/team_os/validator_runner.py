...
def build_validator_prompt(*, contract: dict[str, Any], handoff: dict[str, Any]) -> str:
    ...
    return "\n".join(
        [
            ...
            "3. acceptance — confirm every acceptance/assertion requirement is satisfied.",
            "4. implementation — confirm the described implementation matches the contract and has no scope creep.",
            "5. proof — confirm required proof/commands are present and relevant.",
            "Return exactly one verdict line: VERDICT: PASS or VERDICT: BOUNCE.",
            "BOUNCE if proof is missing, a contract assertion is unverified, scope drift appears, the human gate is off, or auto-Done/dispatch is attempted.",
